	...
	*//**
	...
	public static final class JavaType {
		...
		static {
			...
			SAME_TYPES.put(Char.class, char.class);
	...
	public static final class Time {
		...
		*//**
		...
		public static String getCurrentTime(String timeFormat) {
			...
			return sdf.format(new Date(getCurrentTimeMillis()));
		}
	}
	...
	*//**
	...
	public static final class Exception {
		...
		public static RuntimeException toRuntimeException(
			...
			return new MySQLNonTransientConnectionRuntimeExceptionJDBC4(e);
		}
	...
	public static final class Property {
		...
		*//**
		...
		public static IProperties getProperties(String fileName) {
			...
			return new MyProperty(getProperties(is));
		}
		...
		*//**
		...
		public static <T> T getRandomOneByWeight(java.util.List<T> ls,
			...
			if (ls.size() == 0 || ws.length == 0) {
				throw new RuntimeException("长度不能为0!" + ls.size() + ", "
						+ ws.length);
			}
